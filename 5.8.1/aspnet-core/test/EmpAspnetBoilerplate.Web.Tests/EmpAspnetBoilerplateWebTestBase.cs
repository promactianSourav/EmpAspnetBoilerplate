...
{
    public abstract class EmpAspnetBoilerplateWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EmpAspnetBoilerplateWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EmpAspnetBoilerplateWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EmpAspnetBoilerplateDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EmpAspnetBoilerplateDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EmpAspnetBoilerplateDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EmpAspnetBoilerplateDbContext, Task<T>> func)
        {
            T result;
